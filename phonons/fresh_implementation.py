...
"""
def distances(coords, angles = False):
...
"""
def get_phonon_spectrum(file_path, num_points, raw_coordinates=True, dimer_mass=None,angles=False):
    ...
    if raw_coordinates is True:
        ...
        dists = digital_to_meters_conversion * distances(equally_spaced_data,angles=angles)
